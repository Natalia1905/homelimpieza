    ...
    render() {
        ...
        return (
            <div className="auth-page">
                <Container>
                    <Widget className="widget-auth mx-auto" title={<h3 className="mt-0">CREAR CORREO</h3>}>
                            ...
                            <FormGroup className="mt">
                                ...
                                <InputGroup className="input-group-no-border">
                                    ...
                                    <Input id="email" className="input-transparent pl-3" value={this.state.email}
                                           ...
                                           required name="email" placeholder="Correo"/>
                                </InputGroup>
                            </FormGroup>
                            <FormGroup>
                                ...
                                <InputGroup className="input-group-no-border">
                                    ...
                                    <Input id="password" className="input-transparent pl-3" value={this.state.password}
                                           ...
                                           required name="password" placeholder="Contraseña"/>
                                </InputGroup>
                            </FormGroup>
                            <FormGroup>
                                ...
                                <InputGroup className="input-group-no-border">
                                    ...
                                    <Input id="confirmPassword" className="input-transparent pl-3" value={this.state.confirmPassword}
                                           ...
                                           required name="confirmPassword" placeholder="Contraseña"/>
                                </InputGroup>
                            </FormGroup>
                            <div className="bg-widget-transparent auth-widget-footer">
                                <Button type="submit" color="danger" className="auth-btn"
                                        size="sm" style={{color: '#fff'}}>{this.props.isFetching ? 'Loading...' : 'Registrarse'}</Button>
                                <p className="widget-auth-info mt-4">
                                    Ya tienes correo? Inicia Sesión!
                                </p>
                                <Link className="d-block text-center mb-4" to="login">INICIA SESIÓN</Link>
                ...
                {new Date().getFullYear()} &copy;  <a rel="noopener noreferrer" target="_blank"></a>.                    
                </footer>
            </div>
        );
    }
